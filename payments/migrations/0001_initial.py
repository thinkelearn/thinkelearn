    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['event_type', 'processed_at'], name='payments_we_event_t_c7b23b_idx')],
            },
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('stripe_event_id', models.CharField(blank=True, help_text='Last Stripe event that updated this payment', max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('enrollment_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='lms.enrollmentrecord')),
            ],
            options={
                'ordering': ['-created_at'],
