...
CMD ["bash", "-c", "set -xe; python manage.py migrate --noinput; python manage.py setup_pages; python manage.py setup_portfolio; gunicorn thinkelearn.wsgi:application"]
